...
var adidasCodingListInfo = {
    htmlPath : setCustomPath('./mobile/html/adidas/'),
    jsonFilePath : setCustomPath('./mobile/data/codingList/adidas/'),
    jsonFileName : 'codingListInfo.json'
};


var reebokCodingListInfo = {
    htmlPath : setCustomPath('./mobile/html/reebok/'),
    jsonFilePath : setCustomPath('./mobile/data/codingList/reebok/'),
    jsonFileName : 'codingListInfo.json'
};
...
try{
    ...
    console.log(e);
    writeFile('{}' , adidasCodingListInfo.jsonFilePath)
}
...
try{
    ...
    console.log(e);
    writeFile('{}' , reebokCodingListInfo.jsonFilePath)
}

mobile.use('/',express.static(path.join(__dirname , staticPath)));
mobile.use(bodyParser.json({limit: '50mb'}));
mobile.use(bodyParser.urlencoded({limit: '50mb', extended: true, parameterLimit:50000}));
mobile.set('views', './views');
mobile.set('view engine', 'jade');
...
mobile.get('/adidasCodingList',function(req , res){
    brand = 'adidas';
    htmlListJson = adidasHtmlListJson;

    init('./mobile/html/adidas/');
    res.render('index', {
...
mobile.get('/reebokCodingList',function(req , res){
    console.log(brand);
    brand = 'reebok';
    htmlListJson = reebokHtmlListJson;

    init('./mobile/html/reebok/');
    res.render('index', {
...
mobile.post('/modifyHtmlJson',function(req , res){
